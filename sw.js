const CACHE = 'parcelles-2-v6';
const APP_SHELL = ['./','./index.html','./manifest.webmanifest','./parcelles.svg','./base.css','./components.css','./map.css','./responsive.css','./app.js','./utils.js','./storage.js','./state.js','./import-export.js','./map.js','./sync.js'];
