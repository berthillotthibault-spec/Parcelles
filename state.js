...
export function emptyState(){
  ...
  return {
    ...
    campagnes:[],
    parcelles:[],interventions:[],tasks:[],rotations:[],grazingSessions:[],materiels:[],products:[],clients:[],documents:[],photos:[],points:[],templates:[],importSessions:[],syncConflicts:[],
    preferences:{
      mapLayer:'osm',mapColorMode:'culture',theme:'system',gpsConsent:false,notifications:false,
      autoBackup:true,syncEnabled:false,weatherDays:7,homeCards:['weather','today','alerts','recent'],
      routeProvider:'apple',highContrast:false,onboardingComplete:false
    },
    metadata:{
